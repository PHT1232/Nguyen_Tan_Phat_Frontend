...
export class StructureOutputDto implements IStructureOutputDto {
    unitCode: string;
    unitName: string;
    address: string;
    levelOfUnit: string;
    ...
    constructor(data?: IStructureOutputDto) {
        if (data) {
    ...
    static fromJS(data: any): StructureOutputDto {
        data = typeof data === 'object' ? data : {};
        let result = new StructureOutputDto();
        result.init(data);
        return result;
    }
